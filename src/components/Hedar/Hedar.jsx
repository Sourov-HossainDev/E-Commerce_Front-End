...
import DropDown from '../Lay/DropDown';
            ...
            <Container className="py-10 ">
                ...
                <Flex className="justify-between">
                    <div className='flex items-center gap-x-2.5  '>
                        ...
                        <DropDown dropRef={ref} className='cursor-pointer' >

                            <div  className='flex items-center gap-x-2.5 text-[14px] font-DMsans font-bold '>
